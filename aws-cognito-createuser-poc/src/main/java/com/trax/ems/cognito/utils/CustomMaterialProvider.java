...
public class CustomMaterialProvider implements EncryptionMaterialsProvider {
	...
	public CustomMaterialProvider(String encryptionKeyId, Map<String, String> materialDescription) {
		...
		this.KDF_ENC_INFO = encryptionKeyId; //overriding value with user provided key
	...
	public DecryptionMaterials getDecryptionMaterials(EncryptionContext context) {
		log.info("getDecryptionMaterials called");
		...
		populateMktxEcFromEc(context, ec);
		...
		log.info("getDecryptionMaterials finished!!");
	...
	public EncryptionMaterials getEncryptionMaterials(EncryptionContext context) {
		...
		log.info("getEncryptionMaterials called!!");
		final Map<String, String> ec = new HashMap<>();
		...
		log.info("getEncryptionMaterials finished!!");
	...
	protected String getEncryptionKeyId() {
		log.info("getEncryptionKeyId() called!!");
	...
	protected String selectEncryptionKeyId(EncryptionContext context) throws DynamoDBMappingException {
		log.info("selectEncryptionKeyId() called!!");
	 ...
	 * fields in {@code mktxEc}. Currently, these fields are:
	 * <dl>
	 ...
	 */
	private static void populateMktxEcFromEc(EncryptionContext context, Map<String, String> mktxEc) {
		log.info("populateMktxEcFromEc() called!!");
		...
		log.info("populateMktxEcFromEc() finished!!");
	}
	...
	private static <X extends AmazonWebServiceRequest> X appendUserAgent(final X request) {
		...
		log.info("appendUserAgent() finished!!");
		return request;
	}
