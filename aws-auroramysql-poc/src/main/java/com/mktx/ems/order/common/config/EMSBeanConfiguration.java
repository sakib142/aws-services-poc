package com.mktx.ems.order.common.config;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.datatype.jsr310.JavaTimeModule;
import com.mktx.ems.order.common.constants.EMSConstants;
import com.mktx.ems.order.model.OrderDTO;
...
public class EMSBeanConfiguration {
    ...
    private ObjectMapper objectMapper() {
        /**
         * 
         * Registering JavaTimeModule to support for Java 8 date/time types while using Jackson to marshal to and from
         * JSON.
         * 
         */
    ...
    /**
     * @return {@link JacksonDataFormat} with the custom mapper registered with the {@link JavaTimeModule} support.
     * 
