package com.mktx.cognito.authentication;
...
public class AwsCognitoJwtValidatorUtil {
	...
	/**
	 * This validates the Aws Jwt Token using Nimbus Jose Jwt Library. For reference
	 * please see.
	 * 
	 * @see <a href=
	 ...
	 * @return JWTClaimsSet
	 */
	public static JWTClaimsSet validateAWSJwtToken(String token)
			throws JOSEException, BadJOSEException, MalformedURLException, CustomException, ParseException {
