...
//    @Value("${aws.region}")
    ...
    public void createStreamOnKinesis (String streamName){
    ...
    public void listOfStream(String streamName){
        AmazonKinesis client = kinesisClientBuilder();
    ...
    public void pushToStreamSingleRecord(String awsStreamName, String partitionKey) {
    ...
    public void pushToStream(String awsStreamName, String partitionKey) throws JsonProcessingException, UnsupportedEncodingException, InterruptedException, ExecutionException {
